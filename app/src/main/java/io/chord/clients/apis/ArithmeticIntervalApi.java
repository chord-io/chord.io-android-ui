...
public interface ArithmeticIntervalApi {
   ...
   * 
   * 
   * @return Call&lt;Map&lt;String, Map&lt;String, IntervalQuality&gt;&gt;&gt;
   */
  ...
  Observable<NoteDto> toNote(
            @retrofit2.http.Path("root") String root            ,                 @retrofit2.http.Body IntervalDto body    
  );
  ...
  Observable<String> toString(
            @retrofit2.http.Path("format") IntervalFormat format            ,                 @retrofit2.http.Body IntervalDto body    
  );
